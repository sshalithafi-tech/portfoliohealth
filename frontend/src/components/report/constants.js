...
export const MATURITY_LEVELS = [
  ...
  { level: 5, name: "Predictive", desc: "Predictive, evidence-based decisions. Continuous-improvement culture embedded. All four PPDT dimensions fully aligned; AI-assisted analytics, scenario modelling, and automated lifecycle alerts drive portfolio choices in real time.", color: "#C9A84C" },
];
