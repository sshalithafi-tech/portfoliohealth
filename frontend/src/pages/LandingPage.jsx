...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen relative">
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <Link
                ...
                className="px-5 py-2 btn-liquid rounded-lg"
              >
                Dashboard
              </Link>
            ) : (
              <>
                <Link
                  ...
                  className="px-4 py-2 text-white/65 hover:text-white transition-colors"
                >
                  Sign In
                </Link>
                <Link
      ...
      <div className="relative z-10 pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-4 mb-8">
            <img src={LOGO_MARK} alt="PortfolioHealth" className="w-20 h-20 rounded-2xl object-contain drop-shadow-[0_0_20px_rgba(0,229,255,0.3)]" />
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-white font-['Outfit'] tracking-tight mb-6">
            ...
            <span className="block text-3xl md:text-4xl mt-2 text-white/50">Advisor</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <Link
              ...
              className="group p-8 glass-card rounded-2xl text-left hover:border-[#00E5FF]/30"
            >
            ...
            <Link
              ...
              className="group p-8 glass-card rounded-2xl text-left hover:border-[#238636]/30"
            >
      ...
      {/* Features */}
      <div className="relative z-10 py-20 px-6 border-t border-white/[0.06]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={label} className="p-6 glass-card rounded-xl text-center">
                <div className="w-12 h-12 rounded-lg bg-[#00E5FF]/10 flex items-center justify-center mx-auto mb-4">
